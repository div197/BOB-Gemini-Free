...
**Current source candidate:** `v0.2.0-preview.8` from reviewed source checkpoint `309b512a45fc17bb10de712cd110ee9bd809329b`; locally packaged, signed, and verified, not published
...
| Current Preview 8 candidate | `v0.2.0-preview.8` was packaged from reviewed checkpoint `309b512`, signed through the local Keychain, and verified locally; it is not a public release | VERIFIED_LOCAL |
...
The reviewed source checkpoint `309b512a45fc17bb10de712cd110ee9bd809329b`
