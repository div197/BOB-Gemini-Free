...
universal packaging, local health/static-route startup, packaged route-control
smoke, Keychain-backed manifest signing, and exact local asset verification all
