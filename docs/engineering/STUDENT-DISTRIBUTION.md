...
**Status:** public macOS Preview 10 and an older Windows preview artifact are
...
- The public [`v0.2.0-preview.10` controlled macOS preview](https://github.com/div197/BOB-Gemini-Free/releases/tag/v0.2.0-preview.10)
  ...
  byte-for-byte with the local signed inputs. A preserved Preview 9 bundle
  copy completed the real consented replacement/restart path. The
...
manifests are published, students must use the Preview 10 release page or the
documented pilot path.

## Automatic update plan and 30-device rollout gate

The current Preview 10 is a public native preview with a signed, build-pinned
...
change, but its preview-only path can select the published same-key Preview 10;
...
`v0.2.0-preview.10` installations already carry the current key and do not need
that migration.
...
the [`v0.2.0-preview.10` release page](https://github.com/div197/BOB-Gemini-Free/releases/tag/v0.2.0-preview.10):
...
Mac discovered Preview 10 and a preserved Preview 9 copy completed the
replacement/restart path. Legacy
