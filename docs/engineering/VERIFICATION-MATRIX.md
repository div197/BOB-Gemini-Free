...
The source-hardening tip is `4a0f15d`; the current checkout contains the
deterministic stream-regression and session-bound image-reference follow-ups
after the evidence documents. The local branch is
