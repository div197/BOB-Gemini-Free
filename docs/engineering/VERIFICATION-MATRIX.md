...
telemetry, release-version, settings, and desktop-coexistence hardening. None
...
| Public `main` contains post-Preview 5 source follow-ups | VERIFIED_LIVE | Protected PRs #77–#83 merged the in-app-browser localhost-origin, credential-input, telemetry, release-version, settings, and desktop-coexistence follow-ups; public `main` is `9f11eef922e09110df923205eb9aad90da35e236` | These changes are not in immutable Preview 5 bytes. A new signed preview is required before students receive them. |
