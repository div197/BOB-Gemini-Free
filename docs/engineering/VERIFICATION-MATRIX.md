...
protected PR #77 and PR #78 advanced public `main` to
`ade691db0be9d478cc2feab42e20eb0848f1460e` with browser-boundary evidence and
credential-input probe hygiene. Those follow-ups are source-verified but are
not contained in the immutable Preview 5 assets. Preview 4 assets remain
immutable historical input, while Preview 5 is the current public macOS
prerelease package. The complete local package receipt is in
