...
the release-state documentation and updater-matrix reconciliation. None
...
| Public `main` contains post-Preview 5 source follow-ups | VERIFIED_LIVE | Protected PRs #77–#83 merged the in-app-browser localhost-origin, credential-input, telemetry, release-version, settings, and desktop-coexistence follow-ups; documentation/test reconciliation PR #84 moved public `main` to `0cc81b2029d5dd467f7c96b26a8b812bee1ab461` | These changes are not in immutable Preview 5 bytes. A new signed preview is required before students receive them. |
