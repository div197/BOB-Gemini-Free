...
* The latest stable GitHub release contains CLI binaries. The public [v0.2.0-preview.5 controlled macOS preview](https://github.com/div197/BOB-Gemini-Free/releases/tag/v0.2.0-preview.5) is still the current downloadable universal preview; Preview 4 remains immutable historical input. Public `main` now contains the post-Preview-5 settings, telemetry, release-version, version-aware desktop coexistence, release-state reconciliation, and secure gateway-key transport guard at `49e0d3b`; the immutable Preview 5 package remains frozen at its signed `c28d787` source baseline and does not contain those post-publication follow-ups. A fresh universal `v0.2.0-preview.6` package has been built, signed, verified, and coexistence-smoke-tested locally from that exact merged tip, but has not been published yet. The immutable [v0.2.0-preview.1 migration bridge](https://github.com/div197/BOB-Gemini-Free/releases/tag/v0.2.0-preview.1), historical Preview 3, and superseded Preview 2 remain available as historical release inputs. It is an authentic open-source beta, platform trust is not yet established, and Windows/Linux remain separate preview targets. Stable `v0.2.0` is not yet published; rollback, clean-device, pilot, and provider gates remain open. See [`RELEASE-AUDIT-2026-08-31.md`](docs/engineering/RELEASE-AUDIT-2026-08-31.md), [`PREVIEW-6-LOCAL-VERIFICATION-2026-08-31.md`](docs/engineering/PREVIEW-6-LOCAL-VERIFICATION-2026-08-31.md), and the [`Preview 5 release notes`](docs/engineering/PREVIEW-5-RELEASE-NOTES.md).
...
* The current source has a build-pinned update policy. Newly built previews can
  ...
  current `v0.2.0-preview.6` source candidate.
