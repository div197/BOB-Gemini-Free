...
* The latest stable GitHub release contains CLI binaries. The public [v0.1.7-preview.6 native desktop beta](https://github.com/div197/BOB-Gemini-Free/releases/tag/v0.1.7-preview.6) contains the corrected branded macOS universal package, signed project update manifest, native maximize behavior, default-browser link routing, expanded English/Hindi studio UI, and the updater reliability hotfix; it is an authentic open-source beta, platform trust is not yet established, and Windows/Linux remain separate preview targets.
...
* Preview 6 has a build-pinned preview update channel. From Preview 4 onward,
...
Production native builds must embed their public key at build time. Preview 6
