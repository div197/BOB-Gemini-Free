...
- 🌉 **यूनिवर्सल 3-इन-1 प्रोटोकॉल**: एक ही सिंगल गेटवे से **OpenAI**, **Anthropic Messages (Claude Code CLI)** और **Google Gemini v1beta** का सीधा अनुवाद।
...
* ⚡ [**BOB Gemini Free**](https://github.com/div197/bob-gemini-free) — OpenAI, Anthropic, और Gemini प्रोटोकॉल्स को सपोर्ट करने वाला यूनिवर्सल 3-इन-1 गेटवे।
